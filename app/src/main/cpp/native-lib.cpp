...
Java_com_example_cpp_1lib_1test2_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_cpp_1lib_1test2_MainActivity_sumFromJni(
        JNIEnv* env,
        jobject /* this */,
        jint a,
        jint b) {
...
Java_com_example_cpp_1lib_1test2_MainActivity_convertToGrayscale(
        JNIEnv* env,
        jobject /* this */,
        jintArray pixels,
        jint width,
